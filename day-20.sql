...
SELECT cl.log_id, cl.break_id, cl.cocoa_id, ct.cocoa_name, bs.location_id, l.location_name
FROM cocoa_logs cl
LEFT JOIN cocoa_types ct ON 
  cl.cocoa_id = ct.cocoa_id
LEFT JOIN break_schedule bs ON 
  cl.break_id = bs.break_id
LEFT JOIN locations l ON 
  bs.location_id = l.location_id
